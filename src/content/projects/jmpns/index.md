...
![JMPNS Mockup](./jmpns-home-mockup-edited.jpg)
...
![An image that details the various scenarios that a user of the JMPNS website might go through. Part of the user experience research process.](./360-yessikenney-scenarios.png)

![Low Fi Wireframes](./Low-Fi-Wireframes.png)
![Something](./8fd749162565169.63d80069795bb.png)
![Spreadsheet detailing the contents of the JMPNS website before the redesign.](./360-yessikenney-ia_page_1.png)

![A chart detailing how the information and pages on a webpage should be organized.](./ipad-e28093-1.png)
![A mind map, or brain storm cloud, using Coggle software web app](./jmpns.png)
